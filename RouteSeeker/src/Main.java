...
public class Main {
    ...
    public static String[] fieldScheme = {     // w = Wall/obstacle;    l = Loading station;    s = suitable to Shoot;     i = Initiation line
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int trial = 1; trial <= amountOfTrials; ++trial) {
            ...
            Robot robot = new Robot (field, pickStartingPosition(initLine, initLineValues,
                    totalInitLineValue), maxAcc, 1, 3, tactAmount);
        ...
        for (int i = 0; i < allies[1].sequence.size(); ++i) {
            allies[1].sequence.get(i).cell.type = allies[1].sequence.get(i).cell.type.concat("\u001B[34m" + (i+1) + "\u001B[0m");
        }
